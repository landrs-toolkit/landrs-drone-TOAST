...
py_drone_doc_gen.py generates the json-ld file py_drone_doc.py, using library https://github.com/HTTP-APIs/hydra-python-core, which is used to generate the api.
