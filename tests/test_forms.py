...
import copy
import shutil
from config.config_generate_form import generate_form, sort_composite_property, assign_id, check_property, find_paired_properties
from config.config_graph_shacl import RDFHandler, SHACL
...
#     assert filecmp.cmp('result.html', 'tests/expected_results/empty_shape.html')
