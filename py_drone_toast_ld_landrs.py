...
def sensors():
    ...
    return json.dumps({"error": "URL not found"}), 500
...
def parse_kg():
    ...
    for row_sensor in result_sensor:
        ...
        sensor_dict = {
            ontology_hosts: values_sensor[1], ontology_parts: values_sensor[2]}
        ...
        app.add_url_rule(
            ...
            '/api/v1/sensors/'+values_sensor[0].replace(ontology_prefix, ''),
